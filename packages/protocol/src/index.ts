...
export const MOBS: Record<MobKind, MobStats> = {
  boar: { name: "Risen Husk", level: 2, hpMax: 40, damageMin: 4, damageMax: 7, moveSpeed: 2.2, attackRange: 1.8, aggroRange: 8, aggressive: false, xp: 18, shards: 4, drop: "hide", dropChance: 0.8 },
  wolf: { name: "Bone Stalker", level: 4, hpMax: 55, damageMin: 7, damageMax: 12, moveSpeed: 3.2, attackRange: 2, aggroRange: 10, aggressive: true, xp: 30, shards: 8, drop: "fang", dropChance: 0.7 },
  golem: { name: "Grave Warden", level: 8, hpMax: 140, damageMin: 14, damageMax: 22, moveSpeed: 1.3, attackRange: 2.2, aggroRange: 9, aggressive: true, xp: 75, shards: 20, drop: "golem_core", dropChance: 0.45 },
